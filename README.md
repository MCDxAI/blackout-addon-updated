...
> A port of the original BlackOut addon by KassuK (now unmaintained), updated for **Minecraft 26.2** and **Meteor Client 26.2**.
...
See [CHANGELOG.md](CHANGELOG.md) for the port and update history.
