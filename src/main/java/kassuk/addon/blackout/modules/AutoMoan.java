...
public class AutoMoan extends BlackOutModule {
  ...
  private final Setting<MoanMode> moanmode =
      sgGeneral.add(
          new EnumSetting.Builder<MoanMode>()
              .name("Message Mode")
  ...
  private static final String[] Submissive =
      new String[] {
        ...
        // The fact that someone has actually said all of these non ironically shows how weird the
        // world is
  ...
  private static final String[] Dominant =
      new String[] {
        ...
        // this one was inspired by a gif of a black man twerking why the fuck does the cheating com
        // find those funny
        ...
        "why wont u say the last message",
        // if anyone asks what I did during my vacation I can proudly tell them I wasted multiple
        // hours writing things gay people can say during sex
        // The fact that I have said a few of these frightens me : SigmaClientWasTaken 2023 wtf
        // sigma
      };
  ...
  private void onTick(TickEvent.Pre event) {
    timer++;
    // I fucking got perm banned on a really important server to test this out you all better
    // fucking enjoy using this
  ...
  private void MOAN() {
    ...
    switch (moanmode.get()) {
      // Skidding AutoEz for this is harder than just making this fully myself but what I start I
      // finish
      case Submissive -> {
