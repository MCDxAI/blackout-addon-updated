...
public class ElytraFlyPlus extends BlackOutModule {
  ...
  private final Setting<Boolean> stopWater =
      sgGeneral.add(
  ...
  private final Setting<Boolean> stopLava =
      sgGeneral.add(
          new BoolSetting.Builder()
              .name("Stop Lava")
  ...
  private final Setting<Double> constSpeed =
      sgSpeed.add(
          new DoubleSetting.Builder()
              .name("Const Speed")
  ...
  private final Setting<Double> constAcceleration =
      sgSpeed.add(
          new DoubleSetting.Builder()
  ...
  private final Setting<Boolean> constStop =
      sgSpeed.add(
          new BoolSetting.Builder()
              .name("Const Stop")
  ...
  private double calcAcceleration(double vx, double vz, double x, double z) {
    ...
    double xz = x * x + z * z;
    return (Math.sqrt(
                xz * constSpeed.get() * constSpeed.get()
                    - x * x * vz * vz
                    - z * z * vx * vx
                    + 2 * x * z * vx * vz)
            - x * vx
