...
public class BlackOut extends MeteorAddon {
  ...
  public static final Category BLACKOUT =
      new Category("BlackOut", () -> Items.END_CRYSTAL.getDefaultInstance());
  public static final Category SETTINGS =
      new Category("Settings", () -> Items.OBSIDIAN.getDefaultInstance());
  ...
  public static final String COLOR =
      "Color is the visual perception of different wavelengths of light as hue, saturation, and brightness";
